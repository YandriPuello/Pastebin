 ...
 * @author Yandri
 */
@WebServlet(name = "DeletePaste", urlPatterns = {"/DeletePaste", "/eliminar"})
public class DeletePaste extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        jpaService.deleteObject(Codigo.class, codigo.getIdcodigo());
